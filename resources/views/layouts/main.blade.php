        ...
        <nav class='border-b border-gray-800'>
            <div class='container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6'>
                <ul class="flex flex-col md:flex-row items-center">
                    <li>
                        <a href="{{ route('movies.index') }}" class="">
                ...
                <div class="flex flex-col md:flex-row items-center">
                    <div class="relative mt-3 md:mt-0">
                        <input type="text" class="bg-gray-800 text-sm rounded-full focus:outline-none focus:shadow-outline pl-8 w-64 px-4 py-1" placeholder='Search'>
                    ...
                    <div class="md:ml-4 mt-3 md:mt-0">
                        <a href="#" class="">
                            <img src="/img/avatar.png" alt="img" class="rounded-full w-8 h-8">
                        </a>
                    </div>
                </div>
            </div>
